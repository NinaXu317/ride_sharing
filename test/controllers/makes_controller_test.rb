...
class MakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create make" do
    assert_difference('Make.count') do
      post makes_url, params: { make: { request_id: @make.request_id, user_id: @make.user_id } }
    end
  ...
  test "should update make" do
    patch make_url(@make), params: { make: { request_id: @make.request_id, user_id: @make.user_id } }
